...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFB] flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 px-4 pt-6 pb-12 sm:px-6 sm:pb-16 lg:px-8 lg:pb-20 max-w-7xl mx-auto w-full">
      ...
      <div className="flex-1 flex flex-col justify-start w-full text-left">
        ...
        <Button
          ...
          className="px-5 sm:px-6 py-2 sm:py-2.5 bg-primary text-white text-sm sm:text-base font-semibold rounded-lg shadow-md hover:shadow-lg transition-all lg:max-w-xs"
        >

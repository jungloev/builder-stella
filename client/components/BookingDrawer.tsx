...
export function BookingDrawer({
  ...
  // Drawer has a fixed height; no measurement callback needed
  ...
  return (
    <>
      ...
      >
        <div
          ref={drawerPanelRef}
          className="max-w-[390px] mx-auto rounded-t-2xl p-6 flex flex-col gap-4 shadow-lg h-[200px] overflow-y-auto"
          style={{
